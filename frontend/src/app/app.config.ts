...
function interceptorConfigFactory(): MsalInterceptorConfiguration { return { interactionType: InteractionType.Redirect, protectedResourceMap: new Map([[`${environment.apiUrl}/*`, [environment.msal.apiScope]]]) }; }

const msalProviders = environment.authEnabled ? [
